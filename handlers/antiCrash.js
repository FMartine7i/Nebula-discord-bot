...
const webhook = new WebhookClient({
  url: 'https://discord.com/api/webhooks/1285640346574913627/jouCgkN_deBmiJcwFGA5larBLgwOzvQF2M2nEgJX8w2PLzDHnnvbt_UoRPWeT19hqdv4'
})

module.exports = (client) => {
  const embed = new EmbedBuilder().setColor('#e3245e')
  client.on('error', (err) => {
    console.log(err)
    embed
